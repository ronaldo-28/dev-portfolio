...
export const Hero = () => {
  ...
  // Used to be a marquee expand/collapse toggle (Skills lived inside this
  // file). Now that Skills is its own section, this just scrolls down to
  // it — the expand/collapse control moved to Skills.jsx itself.
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center overflow-hidden">
      ...
      {/* Scroll indicator — jumps to the Skills section below */}
      <div
